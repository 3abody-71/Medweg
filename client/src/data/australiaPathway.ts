...
export const australiaPathway = {
  ...
  hospitals: [
    ...
    { state: "Victoria", city: "Melbourne", name: "Austin Hospital", image: "/assets/australia/hospitals/austin-hospital.jpg", body: "The Austin Health network provides tertiary care, teaching, and research across Melbourne’s north-east, including specialist services.", url: "https://www.austin.org.au/", photoCredit: "Representative Melbourne hospital photo / Wikimedia Commons" },
